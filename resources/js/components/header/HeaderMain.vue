<template>
    <header v-if="token" class="navbar-light navbar-sticky">
        <!-- Logo Nav START -->
                    ...
                    <ul class="navbar-nav navbar-nav-scroll mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="demoMenu">
                                ...
                                <li> <a class="dropdown-item" href="index-11.html">Home Workshop<span class="badge bg-success ms-2 smaller">New</span></a></li>
                            </ul>
                        </li>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        ...
                                        <li> <a class="dropdown-item" href="course-detail-module.html">Course Detail Module<span class="badge bg-success ms-2 smaller">New</span></a></li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        <li> <a class="dropdown-item" href="docs/snippet-hero-12.html">Hero Form<span class="badge bg-success ms-2 smaller">New</span></a></li>
                                        <li> <a class="dropdown-item" href="docs/snippet-hero-13.html">Hero Vector<span class="badge bg-success ms-2 smaller">New</span></a></a></li>
                                ...
                                <li> <a class="dropdown-item" href="workshop-detail.html">Workshop Detail<span class="badge bg-success ms-2 smaller">New</span></a></li>
