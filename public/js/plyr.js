...
/***/ "./resources/assets/vendor/plyr/plyr.js":
/*!**********************************************!*\
  !*** ./resources/assets/vendor/plyr/plyr.js ***!
  \**********************************************/
  ...
  var ht = {
    ...
    ready: function ready() {
      ...
      W(a) ? (a = e.media.getAttribute(e.config.attributes.embed.id), l = e.media.getAttribute(e.config.attributes.embed.hash)) : l = function (e) {
        var t = e.match( /*#__PURE__*/_wrapRegExp(/^.*(?:vimeo.com\/|video\/)(?:\d+)(?:\?.*&*h=|\/)+([\d,a-f]+)/, {
          hash: 1
        }));
      ...
      e(this, "load", function () {
        ...
        if (_this32.loaded && F(e) && ["touchmove", "mousemove"].includes(e.type) && _this32.player.media.duration) {
          if ("touchmove" === e.type) _this32.seekTime = _this32.player.media.duration * (_this32.player.elements.inputs.seek.value / 100);else {
            var _t24 = _this32.player.elements.progress.getBoundingClientRect(),
              _i18 = 100 / _t24.width * (e.pageX - _t24.left);
  ...
  var vt = {
    ...
    change: function change(e) {
      ...
      Q(e, "sources.length") ? (Le.cancelRequests.call(this), this.destroy.call(this, function () {
        ...
        var t = e.sources,
          i = e.type,
          _t25 = _slicedToArray(t, 1),
          _t25$ = _t25[0],
          _t25$$provider = _t25$.provider,
          s = _t25$$provider === void 0 ? Ge.html5 : _t25$$provider,
          n = _t25$.src,
          a = "html5" === s ? i : "div",
          l = "html5" === s ? {} : {
            src: n
    ...
    function wt(t, i) {
      ...
      if (e(this, "play", function () {
        ...
        if (_this35.supported.ui && !_this35.isAudio) {
          var _t26 = oe(_this35.elements.container, _this35.config.classNames.hideControls),
            _i20 = void 0 === e ? void 0 : !e,
            _s18 = le(_this35.elements.container, _this35.config.classNames.hideControls, _i20);
          if (_s18 && q(_this35.config.controls) && _this35.config.controls.includes("settings") && !W(_this35.config.settings) && We.toggleMenu.call(_this35, !1), _s18 !== _t26) {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/plyr/plyr.js");
/******/ 	
/******/ })()
;