      ...
      return a(t, [{
        ...
        value: function value() {
          var t = this.w.globals,
            e = [],
            i = [];
          if (t.series.length) for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++) for (var s = 0, r = 0, o = 0; o < t.series.length; o++) null !== t.series[o][a] && f.isNumber(t.series[o][a]) && (t.series[o][a] > 0 ? s = s + parseFloat(t.series[o][a]) + 1e-4 : r += parseFloat(t.series[o][a])), o === t.series.length - 1 && (e.push(s), i.push(r));
          ...
          if (0 !== a.responsive.length) {
            ...
            var r = new H({}),
              o = function o() {
                ...
                } else for (var l = 0; l < s.length; l++) o < s[l].breakpoint && (t = y.extendArrayProps(r, s[l].options, i), t = f.extend(i.config, t), e.overrideResponsiveOptions(t));
              };
            if (t) {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/apexcharts/js/apexcharts.min.js");
/******/ 	
/******/ })()
;